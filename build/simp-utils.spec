...
if src_dir == "\0" then
  io.stderr:write("WARNING: Cannot determine project's src_dir (tried: '" .. table.concat(potential_src_dirs, "', '") .."')\n")
  io.stderr:write("         Declare pup_module_info_dirwith path to project\n")
  error(
